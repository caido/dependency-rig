...
mod tests {
    ...
    use crate::providers::openai::responses_api::{
        ...
        ResponsesUsage, terminal_metadata_from_response,
    };
    use futures::{SinkExt, StreamExt};
    use serde_json::json;
    use std::time::Duration;
    ...
    fn terminal_response_accepts_completed_and_incomplete_statuses() {
        ...
        let incomplete = terminal_response_result(incomplete)
            .expect("incomplete response should remain a successful terminal response");
        assert_eq!(
            terminal_metadata_from_response(&incomplete)
                .expect("incomplete terminal metadata should be present")
                .reason(),
